...
# Plotting the first 100 motor vehicle thefts
ggmap(chicago) + geom_point(data = mvt[1:100,], aes(x = Longitude, y = Latitude))

# Rounding the latitude and longitude to 2 digits of accuracy, and create a crime counts data frame for each area
...
# Plot the number of murder on the map of the United States:
...
# Redo the plot with murder rate
